...
<div id="container">
  ...
  <div id="header_container">
   ...
   <div id="header_container">
        <p><b><u><div id="inner_text"> Active Users List</u></b>
       <div id="inner_text">

           <?php
               $connect=mysqli_connect('localhost','root','','irpts');
               $sql = "SELECT userid,username,usertype,status,stationname FROM users,stations where usertype!='admin' and users.stationcode=stations.stationcode and status='active'";
		...
		<td ><strong>User Name</strong></td>
            ...
            <?php   
                ...
                $item = "<a href='ChangeStatus.php?userid=$userid'> &nbsp Block...</a>";
            ?>
             <tr>
