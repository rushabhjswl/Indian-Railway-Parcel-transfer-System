...
else
{
     ...
     $sql = "INSERT INTO `trans`(`trans_code`, `parcelcode`, `tr_date`, `tr_type`, `stationcode`, `nextstationcode`, `discription`, `status`) "
            . "VALUES ($newtranscode,$parcelcode,'$dt_db',4,$thisstationcode,$thisstationcode,'Delivered','n')";
     if ($connect->query($sql) === TRUE)
     {
          $msg= "Parcel delivery done.";
     } 
     else
     {
...
?>
          <li> <a href='ParcelDeliveryFinal.php?hello=true'>
