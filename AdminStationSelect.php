...
<div id="container">
  ...
  <div id="header_container">
    <div id="page_header">
      ...
      <div id="header_menu">
        <ul>
           ...
           ?>
            <li> <a href='AdminStationSelect.php?hello=true'>
   ...
   <div id="header_container"> 
       <p><b><u><div id="inner_text">Booked Parcels</u></b>
           <form action="AllBookedParcelsReport.php" method="post">
              <table width="500px" border="1" align="center">
               <tr>   
                   <td align="left" width="250px">Select Station :</td>
                   <td align="left">
                   <?php
                  ...
                  { ?>
                    <tr>
                       <td align="left"><input type="submit"  value="Show Booked Parcels" ></td>
