...
<div id="container">
  ...
  <div id="header_container">
   ...
   <div id="header_container">
        <p><b><u><div id="inner_text">Users List</u></b>
       <div id="inner_text">

           <?php
               $connect=mysqli_connect('localhost','root','','irpts');
               $sql = "SELECT username,usertype,status,stationname FROM users,stations where usertype!='admin' and users.stationcode=stations.stationcode";
